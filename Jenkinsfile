pipeline {
    ...
    stages {
        stage("Clone File System Cryptography API from Github") {
            steps {
                echo "Cloning File System Cryptography API from Github. Please Wait..."
                git branch: 'main',
                    url: 'https://github.com/Elleined/file-system-cryptography-api'
                echo "Cloning File System Cryptography API from Github. Success!"
            }
        }
        ...
        stage("Push docker image to DockerHub") {
            steps {
                ...
                sh 'docker tag fsca:latest elleined/fsca:latest'
                sh 'docker push elleined/fsca:latest'
